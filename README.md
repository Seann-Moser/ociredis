...
[![GoDoc](https://godoc.org/github.com/Seann-Moser/ociredis?status.svg)](https://godoc.org/github.com/Seann-Moser/ociredis)
...
- [Pub/Sub](https://godoc.org/github.com/Seann-Moser/ociredis#PubSub).
- [Transactions](https://godoc.org/github.com/Seann-Moser/ociredis#Multi).
- [Pipeline](https://godoc.org/github.com/Seann-Moser/ociredis#example-Client-Pipeline) and [TxPipeline](https://godoc.org/github.com/Seann-Moser/ociredis#example-Client-TxPipeline).
- [Scripting](https://godoc.org/github.com/Seann-Moser/ociredis#Script).
- [Timeouts](https://godoc.org/github.com/Seann-Moser/ociredis#Options).
- [Redis Sentinel](https://godoc.org/github.com/Seann-Moser/ociredis#NewFailoverClient).
- [Redis Cluster](https://godoc.org/github.com/Seann-Moser/ociredis#NewClusterClient).
- [Ring](https://godoc.org/github.com/Seann-Moser/ociredis#NewRing).
- [Instrumentation](https://godoc.org/github.com/Seann-Moser/ociredis#ex-package--Instrumentation).
- [Cache friendly](https://github.com/go-redis/cache).
- [Rate limiting](https://github.com/Seann-Moser/ociredis_rate).
- [Distributed Locks](https://github.com/bsm/redis-lock).

API docs: https://godoc.org/github.com/Seann-Moser/ociredis.
Examples: https://godoc.org/github.com/Seann-Moser/ociredis#pkg-examples.
...
```shell
go get -u github.com/Seann-Moser/ociredis
```

Import:

```go
import "github.com/Seann-Moser/ociredis"
```
...
Please go through [examples](https://godoc.org/github.com/Seann-Moser/ociredis#pkg-examples) to get an idea how to use this package.
